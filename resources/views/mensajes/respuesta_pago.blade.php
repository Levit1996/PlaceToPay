...
<div class="card" style="width: 15rem; float:right; margin-top:75px; margin-right:325px;">
  <ul class="list-group list-group-flush">
    <li class="list-group-item" style="padding: 40px; background-color: #60d586;"><p style="color:white; font-size:20px; text-align:center;" class="small">Total pagado</p><p style="color:white; text-align:center;"><strong>{{$dato->moneda}} ${{$dato->monto}}</strong></p>
...
<div class="card" style="float:left; margin-left:380px; width: 25rem;">
  <ul class="list-group list-group-flush">
    <li class="list-group-item" style=" background-color: #60d586;"><P style="font-size:20px; text-align:center; color:white;">Estado de pago: <b>{{$dato->estado}}</b></p></span></li>
